...
void MoreBibleTextsWindow::showTable(QStringList rows)
{
  ...
  // http://www.matcraft.org/MatCrossBible/BibleTexts/v3/Bulgarian_VEREN2001.hbt
  // enable/disable
  // ============================================================
  //
...
void MoreBibleTextsWindow::slotAnchorClicked(const QUrl &link)
{
  ...
  //
  // http://www.matcraft.org/MatCrossBible/BibleTexts/v3/Bulgarian_Prot1940.hbt
  // |            host       |           path            |      fileName      |
  //
...
void MoreTRFilesWindow::showTable(QStringList rows)
{
  ...
  // 2019.04.30
  // Hungarian.tr
  // http://www.matcraft.org/MatCrossBible/Tr/v3.0.0/Hungarian.tr
  // full/partial
  // ============================================================
  //
